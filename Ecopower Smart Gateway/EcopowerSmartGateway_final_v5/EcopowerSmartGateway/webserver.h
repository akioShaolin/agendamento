...
#include "config.h"
#include <EEPROM.h> // Necessário para a função saveConfig
...
public:
    WebServerManager(ESP8266WebServer* srv) : server(srv) {}
...
<body>
    ...
    void handlePostConfig() {
        ...
        // Correção do erro de escopo: chama a função global saveConfig
        saveConfig();
