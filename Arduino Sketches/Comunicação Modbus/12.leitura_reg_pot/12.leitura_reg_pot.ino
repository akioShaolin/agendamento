...
uint16_t WRITE_REG_ADDR = 0x988A; // Endereço do registrador 40301 (conforme seu uso anterior)
uint16_t READ_REG_ADDR = 0x9D6C;  // Endereço do registrador 40301 (conforme seu uso anterior)
