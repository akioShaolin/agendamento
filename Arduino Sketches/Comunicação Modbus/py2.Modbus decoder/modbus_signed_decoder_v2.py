...
def decode_modbus_log(log_text: str):
    ...
    for idx, frame in enumerate(frames, 1):
        ...
        if data['type'] == 'REQUEST':
            ...
            for i, val in enumerate(data['write_values']):
                hex_val = f"0x{val:04X}"
                unsigned = val
                signed = decode_signed_16bit(val)
                float_16bit = decode_float_16bit(val)
                output.append(f"      - {hex_val}: Unsigned={unsigned}, Signed={signed}, Float16bit={float_16bit:.2f}")
...
log_data = """
402.797 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
402.855 [RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 00 00 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 DA FC 
402.906 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
402.938 [RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 00 00 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 DA FC 
402.990 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
403.039 [RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 00 00 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 DA FC 
403.108 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
403.144 [RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 00 00 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 DA FC 
403.192 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
403.249 [RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 00 00 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 DA FC 
403.300 [RX] 02 17 12 18 00 00 00 00 00 00 05 00 17 00 00 03 E8 00 3B 9B EE 74 A8 
"""
