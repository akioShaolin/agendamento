...
def find_modbus_frames(byte_stream: bytes) -> list:
    ...
    Handles the concatenation problem by checking all possible frame lengths
...
def decode_modbus_log(log_text: str):
    ...
    for idx, frame in enumerate(frames, 1):
        ...
        if data['type'] == 'REQUEST':
            ...
            for val in data['write_values']:
                output.append(f"      - 0x{val:04X} ({val} decimal)")
            ...
            for reg in data['registers']:
                output.append(f"      - 0x{reg:04X} ({reg} decimal)")
...
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 2C 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 42 71 
[RX] 02 17 12 18 00 00 0E 00 00 00 07 00 1B 00 00 03 E8 00 3B 88 C5 E9 3B 
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 2E 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 3B C9 
[RX] 02 17 12 18 00 00 68 00 00 00 6E 00 6A 00 00 03 E8 00 3B 88 C6 F7 DF 
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 2D 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 7F 8D 
[RX] 02 17 12 18 00 00 68 00 00 00 6E 00 6A 00 00 03 E8 00 3B 88 C6 F7 DF 
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 2C 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 42 71 
[RX] 02 17 12 18 00 00 94 00 00 00 9C 00 96 00 00 03 E8 00 3B 88 C6 52 21 
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 2B 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 F7 05 
[RX] 02 17 12 18 00 00 94 00 00 00 9C 00 96 00 00 03 E8 00 3B 88 C6 52 21
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 29 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 8E BD 
[RX] 02 17 12 18 00 00 C6 00 00 00 CA 00 C8 00 00 03 E8 00 3B 88 C6 2F F6 
[RX] 02 17 C3 4F 00 09 C3 4F 00 0A 14 FF 28 00 55 03 E8 00 00 00 55 00 CF 03 E8 00 55 00 1E 00 00 B3 41 
[RX] 02 17 12 18 00 00 C6 00 00 00 CA 00 C8 00 00 03 E8 00 3B 88 C6 2F F6 
