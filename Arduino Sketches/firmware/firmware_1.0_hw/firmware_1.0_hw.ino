...
#define READ_REG_COUNT      1        // Quantidade de registradores a ler. 1 por 1
#define HR_ACT_PWR_OUT      0x9E4D   //Holding Register Active Power Output. Scale: 1000 [kW]
#define HR_ACT_PWR_LIM_VL   0x9DEC   //Holding Register Active Power Limit Value. Scale: 0.1 [%]  (0~1100)
...
Program programs[NUM_PROGRAMS] PROGMEM = {
  {0x01, 5, 14, 35, 14, 50,  2000, true},
  {0x02, 5, 14, 50, 15,  0, 16500, true},
  {0x03, 6,  9,  0, 10,  0, 10000, true},
  {0x04, 6, 10,  0, 12,  0, 33000, true},
  {0x05, 6, 12,  0, 13,  0,     0, true},
  {0x06, 0,  6,  0,  9,  0,     0, true},
  {0x07, 0,  9,  0, 10,  0,    50, true},
  {0x08, 0, 10,  0, 12,  0, 23000, true}
};

const Program defaultProgram PROGMEM  = {0x00, 0,  0,  0,  0,  0, POT_INV, true};
